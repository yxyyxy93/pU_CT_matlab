...
Filename1 = 'BAM_confidential.mat';
...
process3.fs = 100e6; % MHz
process3.fx = 1 / 1.2e-3; % unit: 1 / m
process3.fy = 1 / 1.2e-3; % unit: 1 / m
...
x = 50 * process3.fx / 1e3;
y = 50 * process3.fy / 1e3;
% x = 55;
% y = 75;
